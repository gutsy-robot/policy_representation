...
baits = True
load_baits = ' --load_baits' if baits else ''
...
# os.system('python scripts/train_agent_classifier.py --data_path ' + data_dir + load_baits + 
...
epochs = 20
os.system('python scripts/train_agent_classifier.py --epochs ' + str(epochs) + ' --num_agents '
          + str(num_agents) + load_baits +
